    ...
    public function index(Request $request)
{
    ...
    // return view('products.index', ['products' => $productsWithType]);
    ...
    {
      //1  // $productTypes = ProductType::all();
        // $vendor = Auth::guard('vendor')->user(); // Retrieve the authenticated vendor
        // return view('products.create', compact('productTypes', 'vendor'));
    //   2  $productTypes = ProductType::all();
    ...
    // Handle the case when the user is not authenticated or doesn't have a recognized role
    ...
    // $vendor = Auth::user();
    // return view('products.create', compact('productTypes', 'vendors'));
    // $vendor = Auth::user(); // Retrieve the authenticated vendor
    // $vendors = Vendor::all(); // Retrieve all vendors
    // return view('products.create', compact('productTypes', 'vendor', 'vendors'));
    }
